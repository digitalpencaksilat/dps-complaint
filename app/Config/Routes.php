...
$routes->get('api/contingents/confirmation-status', 'Api\ContingentConfirmationStatusController::index');
...
$routes->get('admin/complaints/contingents', 'Admin\ComplaintAdminController::contingents');
$routes->get('admin/complaints/contingents/print', 'Admin\ComplaintAdminController::contingentsPrint');
$routes->get('admin/complaints/contingents/excel', 'Admin\ComplaintAdminController::contingentsExcel');
...
$routes->post('admin/complaints/(:num)/delete', 'Admin\ComplaintAdminController::delete/$1');
...
$routes->post('admin/events/(:num)/delete', 'Admin\EventAdminController::delete/$1');
$routes->post('admin/events/(:num)/sync', 'Admin\EventAdminController::sync/$1');
