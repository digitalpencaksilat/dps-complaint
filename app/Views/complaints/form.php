          ...
          <div class="card-body p-3 p-lg-5">
            ...
            >
              ...
              <div class="complaint-stepper mb-4">
                <div class="complaint-stepper-progress">
                  <span>Langkah Pengisian</span>
                  <span data-complaint-step-counter>1 / 4</span>
                </div>
                <ul class="nav nav-tabs modal-tabs complaint-step-tabs" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" type="button" data-complaint-step-target="0">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" type="button" data-complaint-step-target="2">
                      <span class="step-chip">3</span>
                      <span>Official</span>
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" type="button" data-complaint-step-target="3">
              ...
              <div class="tab-content complaint-step-content">
                <div class="tab-pane complaint-step-pane show active" data-complaint-step="0">
                ...
                <div id="complaintDetails" class="tab-pane complaint-step-pane complaint-details" data-complaint-step="1">
                  <div class="form-step-card mb-4">
                  ...
                  <div class="complaint-step-actions">
                    <button type="button" class="btn btn-outline-secondary rounded-pill px-4" data-step-prev>
                      <i class="fas fa-arrow-left me-1"></i>Kembali
                    </button>
                    <button type="button" class="btn btn-dps px-4" data-step-next>
                      Lanjut ke Official <i class="fas fa-arrow-right ms-1"></i>
                    </button>
                  </div>
                </div>

                <div class="tab-pane complaint-step-pane" data-complaint-step="2">
                  <div class="form-step-card mb-4">
                  ...
                  <div class="complaint-step-actions">
                    ...
                    <button type="button" class="btn btn-dps px-4" data-step-next>
                      Review Data <i class="fas fa-arrow-right ms-1"></i>
                    </button>
                  </div>
                </div>

                <div class="tab-pane complaint-step-pane" data-complaint-step="3">
                  <div class="form-step-card mb-4">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <div class="complaint-review-grid">
                        ...
                        <div class="complaint-review-card">
                          <span>Official</span>
                          <strong data-review-official>-</strong>
                          <small data-review-phone>-</small>
                        </div>
                        <div class="complaint-review-card">
                          <span>Tanda Tangan</span>
                          <strong data-review-signature>Belum ada</strong>
                        </div>
                      </div>

                      <div class="complaint-review-list mt-4" data-review-items>
                        <div class="empty-result">Belum ada item complain.</div>
                      </div>
                    </div>
                  </div>
